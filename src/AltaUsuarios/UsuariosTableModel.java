...
public class UsuariosTableModel extends AbstractTableModel {
    ...
    public int getColumnCount() {
        return UsuariosTableModel.UsuariosTableColumns.values().length;
    }

    @Override
    public String getColumnName (int column){
        return UsuariosTableModel.UsuariosTableColumns.values()[column].header;
    }

    @Override
    public Object getValueAt(int rowIndex, int columnIndex) {
        Usuario usuario = usuarios.get(rowIndex);
        switch (UsuariosTableModel.UsuariosTableColumns.values()[columnIndex]){
            case Id:
